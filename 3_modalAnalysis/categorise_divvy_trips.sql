...
SET classification = CASE
    ...
    WHEN EXISTS (
        SELECT 1
        FROM divvy_cta_times_q1 AS start_times,
             divvy_cta_times_q1 AS end_times
...
SET classification = CASE
    ...
    WHEN EXISTS (
        SELECT 1
        FROM divvy_cta_times_q2 AS start_times,
             divvy_cta_times_q2 AS end_times
        WHERE date_to_quarter.start_station_id = start_times.divvy_station_id
        AND date_to_quarter.end_station_id = end_times.divvy_station_id
        AND date_to_quarter.started_at BETWEEN 
            (date_trunc('day', date_to_quarter.started_at) + start_times.arrival_time) 
...
SET classification = CASE
    ...
    WHEN EXISTS (
        SELECT 1
        FROM divvy_cta_times_q3 AS start_times,
             divvy_cta_times_q3 AS end_times
        WHERE date_to_quarter.start_station_id = start_times.divvy_station_id
        AND date_to_quarter.end_station_id = end_times.divvy_station_id
        AND date_to_quarter.started_at BETWEEN 
            (date_trunc('day', date_to_quarter.started_at) + start_times.arrival_time) 
...
SET classification = CASE
    ...
    WHEN EXISTS (
        SELECT 1
        FROM divvy_cta_times_q4 AS start_times,
             divvy_cta_times_q4 AS end_times
        WHERE date_to_quarter.start_station_id = start_times.divvy_station_id
        AND date_to_quarter.end_station_id = end_times.divvy_station_id
        AND date_to_quarter.started_at BETWEEN 
            (date_trunc('day', date_to_quarter.started_at) + start_times.arrival_time) 
